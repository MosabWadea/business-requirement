...
# License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl.html).
{
    ...
    "assets": {
        "web.assets_frontend": ["/business_requirement_deliverable/static/src/scss/brd_portal.scss",],
        "web.assets_tests": ["/business_requirement_deliverable/static/src/js/business_requirement_deliverable_portal_tour.js",],
    },
    "image": [
